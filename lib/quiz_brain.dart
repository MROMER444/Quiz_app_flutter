...
void res(){
  ...
  void nextQuestion(){
    if (questions_number < questionsBank.length - 1){
      questions_number++;
  ...
  String getQuestionText(){
    return questionsBank[questions_number].questionText;
  }

  bool getCorrectAnswear(){
    return questionsBank[questions_number].questionTAnswear;
  }
